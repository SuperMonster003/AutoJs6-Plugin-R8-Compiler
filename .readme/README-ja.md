...
ビルドには JDK 17 以降 (21 推奨) と Android SDK Platform 36 が必要です: ビルドスクリプトが `platforms/android-36/android.jar` をバイト検証してコンパイルライブラリ資産として同梱し, 不一致があれば中断します. 現在の minSdk は 24, targetSdk は 37 です.
